...
public class AquariumTests {
    ...
    private static final String name1 = "Ada";
    private static final String name2 = "Kathy";
    private Fish fish1;
    private Fish fish2;
    ...
    public void set() {
        ...
        aquarium = new Aquarium("Aquarium", 2);
    }
    ...
    public void testReportShouldReturnCorrectReportOfFishInCollection() {
        aquarium.add(fish1);
        aquarium.add(fish2);
        String expected = "Fish available at Aquarium: Ada, Kathy";
